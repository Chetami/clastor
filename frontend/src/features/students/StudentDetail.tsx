...
import { SkeletonCard, SkeletonTimeline } from "@/components/skeletons";
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  if (isLoading) {
    return (
      <div className="space-y-6" aria-busy="true">
        ...
        <Card>
          <CardContent className="flex items-center gap-4 sm:flex-row sm:justify-between">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-6">
            <SkeletonCard titleWidth="w-28" lines={3} />
          </div>
        </div>
        <Card>
          <CardHeader>
