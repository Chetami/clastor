...
/**
 * Team-tutor card illustration — the "group_tutors" characters.
 *
 * Rendered absolutely inside the "Bring on a colleague, cleanly." card in
 ...
 * styles for pixel-precise control. The team card changes width across the
 * responsive layout, so each breakpoint gets its own number set in POSITIONS.
 *
 * IMPORTANT: must sit inside a `position: relative` container — the team
...
const POSITIONS = {
  ...
  /** Desktop (≥1024px). Card is the right grid column. */
  lg: {
    bottom: -10,
    right: 24,
    width: 128,
...
export function TeamTutorIllustration() {
