...
/**
 * Format a number as a whole-number currency (no fraction digits) for compact
 * dashboard stat tiles (defaults to AUD). Pass the tutor's currency. Named
 * distinctly from the 2-dp {@link formatCurrency} used on invoices.
 */
